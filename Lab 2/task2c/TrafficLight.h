/*
  ...
  This file is different from TrafficLight.h from lab 1.
  
  The file contains function prototypes to initialize the LEDs
...
void TL_LED_on(PinPosition pin);

// Takes a PinPosition and turn off the LED connected
// to Port L at the pin position
void TL_LED_off(PinPosition pin);
